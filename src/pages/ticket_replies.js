        ...
        <>
            ...
            <section className="p-3 sm:p-12">
            {
                    ...
                    data.replies.map((msg,i)=>{
                        return(
                            <div key={i} className={`${msg.from==="staff"? "bg-gray-600 text-white" : "bg-gray-100 text-black"} my-2 p-5 rounded-[5px] w-full`}>
                                <p className={`${msg.from==="staff"? "text-white" : "text-gray-600"} text-xs`}>{msg.time}</p>
